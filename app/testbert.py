...
def main():
	...
	# =====================================
	logging_filename = f"../logs/testbert_{args.corpus_name}.log"
...
if __name__ == "__main__":
	...
	parser = argparse.ArgumentParser(prog="bertclf", description="Bert classifier test for perplexity.")
	parser.add_argument("--batch_size", "-bs", type=int, default=8, help="Indicates batch size.")
	parser.add_argument("--train_data_file", "-train", type=str, default="../corpora/domain-adaption/train.csv", help="Path for train file.")
	parser.add_argument("--test_data_file", "-test", type=str, default="../corpora/domain-adaption/test.csv", help="Path for test file.")
