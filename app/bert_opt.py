...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        prog="bert_opt",
        description="Runs bert classification script with multiple arguments.",
    )
    parser.add_argument(
        "--corpus_name",
        "-cn",
        type=str,
        default="poet",
        help="Indicates the corpus. Default is 'poet'. Another possible value is 'year'.",
    )
    parser.add_argument(
        "--domain_adaption",
        "-da",
    ...
    parser.add_argument(
        ...
        type=str,
        default="rede",
        help="Indicates the BERT model name. Default is 'rede' (short for: bert-base-historical-german-rw-cased). Another option is 'deutsch' (short for: bert-base-german-dbmdz-cased).",
    )
    parser.add_argument(
